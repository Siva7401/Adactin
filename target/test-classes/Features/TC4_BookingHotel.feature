...
Feature: Verifying Adactin Hotel Booking page
  ...
  Scenario Outline: Verify Adactin Hotel Booking Page With Valid Credentials
    ...
    Examples: 
      ...
      | siva7401 |   101424 | London   | Hotel Creek | Standard | 1 - One  | 21/06/2022 | 23/06/2022 | 2 - Two       | 1 - One         | barath    | c        | chennai |
  ...
  Scenario Outline: Verify Adactin Hotel Booking Page Without Valid Credentials
    ...
    Examples: 
      ...
      | siva7401 |   101424 | London   | Hotel Creek | Standard | 1 - One  | 21/06/2022 | 23/06/2022 | 2 - Two       | 1 - One         |
